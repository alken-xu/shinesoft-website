  ...
  return (
    <html lang={locale} className="h-full">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@300;400;600&family=IBM+Plex+Sans+JP:wght@300;400;600&family=IBM+Plex+Mono:wght@400&display=swap"
          rel="stylesheet"
        />
